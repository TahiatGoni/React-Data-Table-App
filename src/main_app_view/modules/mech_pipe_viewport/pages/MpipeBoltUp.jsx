...
export default class MpipeBoltUp extends Component {

	constructor(props) {
		super(props)
		this.data = this.props.masterdata["bolts_table"]
		
		this.fields = ["BDiddate", 'BUidno',]
		...
		this.headings = [
			headingObjectFactory("BU request Date", 0),
			headingObjectFactory("BU report no.", 1), 
		...
		this.tableId = "mpipe-boltup-table"
	}
	...
	filterGenerator() {
		...
		filteredData.forEach(element => element['type'] = 'mpipe_boltup')
				...
				<Container fluid>
					<Row>
						<Container className="floating-container" fluid>
							<Col>
								<SearchableTable type={"mpipe_boltup"} id={this.tableId} data={this.data} dataFilter={this.dataFilter} fields={this.fields} headings={this.headings}/>
							</Col>
						</Container>
					</Row>
